  ...
  return (
    <article className="product-card">
      <div className="product-card-image-wrap">
        ...
        {discount ? <span className="discount-chip" title={language === 'bg' ? 'Демо отстъпка' : 'Demo discount'}>-{discount}%</span> : <span className="preview-chip">€10 {language === 'bg' ? 'ДЕМО' : 'DEMO'}</span>}
      </div>
