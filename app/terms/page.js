  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>{bg ? 'Потребителят разполага със законовото право да се откаже от договор от разстояние в 14-дневен срок от получаването на стоката, когато не е приложимо законово изключение. Преди изпращане на връщане клиентът следва да се свърже с ГЕРПИНА по имейл или телефон и да получи указания.' : 'Consumers have the statutory right to withdraw from a distance contract within 14 days of receiving the goods, unless a legal exception applies. Before sending a return, the customer should contact GERPINA by email or phone and obtain return instructions.'}</p>
