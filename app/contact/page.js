  ...
  return (
    <main className="contact-page page-width">
      ...
      <div className="contact-grid">
        ...
        <div className="contact-card"><small>{bg ? 'АДРЕС ПО РЕГИСТРАЦИЯ' : 'REGISTERED ADDRESS'}</small><strong>{siteConfig.company.registeredAddress[language]}</strong><span>{bg ? 'България' : 'Bulgaria'}</span></div>
      </div>
