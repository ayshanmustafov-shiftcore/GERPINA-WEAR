...
export default function CookiesPage() {
  ...
  return (
    <LegalPage eyebrow={bg ? 'НАСТРОЙКИ НА САЙТА' : 'SITE SETTINGS'} title={bg ? 'Политика за бисквитки' : 'Cookie Policy'} intro={bg ? 'Какви технологии за съхранение използва GERPINA Wear.' : 'Storage technologies used by GERPINA Wear.'}>
      ...
      <section><h2>2. {bg ? 'Анализ и реклама' : 'Analytics and advertising'}</h2><p>{bg ? 'Към момента не са активирани рекламни пиксели или аналитични тракери. Ако в бъдеще бъдат добавени Meta Pixel, Google Analytics, Google Ads или други незадължителни технологии, те ще бъдат блокирани до получаване на предварително съгласие, когато такова се изисква.' : 'No advertising pixels or analytics trackers are currently enabled. If Meta Pixel, Google Analytics, Google Ads or other optional technologies are added later, they will be blocked until prior consent is obtained where required.'}</p></section>
