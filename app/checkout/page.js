...
export default function CheckoutPage() {
  ...
  const copy = useMemo(() => language === 'bg' ? {
    ...
    demo: 'ДЕМО РЕЖИМ',
    demoBody: 'Формата е готова визуално. Изпращането по имейл и връзката с Еконт ще бъдат активирани след като потвърдим точния процес, API възможностите и контактните данни.',
    ...
    place: 'Place order',
    demo: 'DEMO MODE',
    demoBody: 'The checkout UI is ready. Email submission and the Econt connection will be activated once the exact process, API options and contact details are confirmed.',
