...
export default function CheckoutPage() {
  ...
  const copy = useMemo(() => language === 'bg' ? {
    ...
    deliveryText: 'Градовете и офисите се зареждат директно от тестовата система на Еконт.',
    ...
    shippingPayer: 'В тестовия модел клиентът заплаща и куриерската услуга при получаване.',
    ...
    demoBody: 'Това е реална връзка към тестовата API среда на Еконт. Градове, офиси и изчисляване идват от Еконт, но не се създава реална товарителница и не се заявява куриер.',
    success: 'Данните са валидирани успешно от тестовата система на Еконт. Не е създадена реална пратка.',
    ...
    apiError: 'Връзката с тестовата система на Еконт не отговори. Опитай отново.',
  } : {
    ...
    deliveryText: 'Cities and offices are loaded directly from Econt’s test environment.',
    office: 'Econt office',
    ...
    shippingPayer: 'In the test setup the customer also pays the courier fee on receipt.',
    summary: 'Your order',
    items: 'Items',
    ...
    demo: 'ECONT TEST MODE',
    demoBody: 'This is a real connection to Econt’s test API. Cities, offices and price calculation come from Econt, but no real waybill is created and no courier is requested.',
    success: 'The checkout data was successfully validated by Econt’s test environment. No real shipment was created.',
    ...
    apiError: 'Econt’s test environment did not respond. Please try again.',
  }, [language]);
      ...
      <form ref={formRef} className="checkout-layout" onSubmit={submitTest}>
        <div className="checkout-form-column">
          ...
          <section className="checkout-section">
            <div className="checkout-section-heading econt-heading-row">
              ...
              <span className="econt-live-badge">ECONT · TEST API</span>
            </div>
        ...
        <aside className="checkout-summary">
          <div className="checkout-summary-title-row">
            <h2>{copy.summary}</h2>
            <span className="summary-test-pill">TEST</span>
          </div>
          ...
          <button className="place-order-button" type="submit" disabled={submitState.loading}>
          ...
          {submitState.success && <div className="checkout-submit-notice success" role="status">{copy.success}</div>}
